  ...
  days: [
    ...
    { weekday: 3, title: 'Run', type: 'run', blocks: [] },
    {
      ...
      blocks: [
        ...
        { type: 'single', items: [{ exerciseSlug: 'fentes-bulgares', sets: 3, repsMin: 8, repsMax: 10, note: 'Une jambe à la fois (remplace les fentes bulgares)' }] },
        { type: 'single', items: [{ exerciseSlug: 'rdl', sets: 3, repsMin: 8, repsMax: 10, note: 'Hanches vers l’arrière, remplace le RDL' }] },
